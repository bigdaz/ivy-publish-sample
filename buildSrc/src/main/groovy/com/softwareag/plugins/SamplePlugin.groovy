...
class SamplePlugin implements Plugin<Project> {
    ...
    public void apply(Project project) {
        ...
        project.afterEvaluate {
            ...
            configurePublication(project, project.publishing.publications.ivy)
        }
    }
    ...
    def configurePublication(Project project, IvyPublication ivyPublication) {
        ivyPublication.organisation = "sag"
        ivyPublication.revision = project.setup.buildVersion
